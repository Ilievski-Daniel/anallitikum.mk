  ...
  <div class="container" >
    ...
    <div class="nav-scroller py-1 ">
      <nav class="nav d-flex " id="center" style="font-size: 15px; ">
        ...
        <a class="p-2 text-white fw-bold" href="{{route('blog.filmovi')}}">ФИЛМОВИ</a>
        <a class="p-2 text-white fw-bold" href="{{route('blog.sport')}}">СПОРТ</a>
        <a class="p-2 text-white fw-bold" href="{{route('blog.donaci')}}">ДОНАЦИИ</a>
        <a class="p-2 text-white fw-bold" href="{{route('blog.citati')}}">ЦИТАТИ</a>
        <a class="p-2 text-white fw-bold" href="{{route('blog.kontakt')}}">КОНТАКТ</a>
