...
<div class="container">
  <div class="d-flex justify-content-center  ">
    ...
    <div class="card p-5" style="width:1000px">
      {{-- <p>{{ date('M j, Y', strtotime($value->created_at))}}</p> --}}
      <h1 class="p-1 fw-bold fontlarge">{{$blog->title}}</h1>
      <img src="https://static.wixstatic.com/media/a1e95a_26e1b79e48d5425589a6c5d5741abdc7~mv2.jpg/v1/fill/w_754,h_502,al_c,q_90/a1e95a_26e1b79e48d5425589a6c5d5741abdc7~mv2.webp" class=" " alt="..." style="height: 400px ;">
      <p class="p-1 fw-bold mt-4">{{$blog->body}}</p>
    </div> 
